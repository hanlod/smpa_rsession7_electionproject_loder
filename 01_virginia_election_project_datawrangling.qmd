...
joined_vacomparison <- joined_vacomparison %>% 
  mutate(mcauliffe_overperform = pct_mcauliffe - biden_pct)
...
joined_vacomparison <- joined_vacomparison %>% 
  mutate(biden_overperform = biden_pct - pct_mcauliffe)
...
joined_vacomparison <- joined_vacomparison %>% 
  mutate(avg_pct_democrat = (biden_pct + pct_mcauliffe) / 2)
...
joined_vacomparison <- joined_vacomparison %>% 
  mutate(avg_pct_republican = (trump_pct + pct_youngkin) / 2)
